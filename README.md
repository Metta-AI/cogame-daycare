...
A policy can be a prompt, a scripted baseline, or an external action player.
...
External action players receive the same private role observation and return a
complete standing order. The game validates orders and owns results and replay.
